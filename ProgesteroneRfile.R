...
#logistic regression analysis with Progesterone as IV
...
logitmodel <- glm(AcnePresent ~ Progesterone, data=DATA, family="binomial")
#create predictions
...
#accuracy rate is 80% which is good
...
#progesterone graph shows line with slope so assumption is met
...
#run regression
summary(logitmodel)
#p value is > .05 so amount of progesterone is not a significant predictor of women having acne
